...
class AwsWellarchitectedWorkloadLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_wellarchitected_workload_local'
    workload_name = Column('workload_name', Text, nullable=True)
    workload_arn = Column('workload_arn', Text, nullable=True)
    workload_id = Column('workload_id', Text, nullable=True)
    architectural_design = Column('architectural_design', Text, nullable=True)
...
cache = select(AwsWellarchitectedWorkload).select_from(AwsWellarchitectedWorkload)
create_materialized_view('aws_wellarchitected_workload_local', cache, db.metadata_materialized)
