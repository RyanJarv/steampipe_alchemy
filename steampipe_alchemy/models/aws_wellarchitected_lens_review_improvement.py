...
class AwsWellarchitectedLensReviewImprovement(Base, FormatMixins):
    __tablename__ = 'aws_wellarchitected_lens_review_improvement'
    improvement_plans = Column('improvement_plans', JSON, nullable=True)
