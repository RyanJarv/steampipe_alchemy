...
class AwsRedshiftEventSubscriptionLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_redshift_event_subscription_local'
    cust_subscription_id = Column('cust_subscription_id', Text, nullable=True)
    customer_aws_id = Column('customer_aws_id', Text, nullable=True)
    enabled = Column('enabled', Boolean, nullable=True)
    severity = Column('severity', Text, nullable=True)
...
cache = select(AwsRedshiftEventSubscription).select_from(AwsRedshiftEventSubscription)
create_materialized_view('aws_redshift_event_subscription_local', cache, db.metadata_materialized)
