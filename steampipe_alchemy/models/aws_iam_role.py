from steampipe_alchemy.types.aws_iam_role import *
...
class AwsIamRole(Base):
    ...
    instance_profile_arns: InstanceProfileArns = Column('instance_profile_arns', JSON, nullable=True)
    ...
    assume_role_policy: AssumeRolePolicy = Column('assume_role_policy', JSON, nullable=True)
    assume_role_policy_std: AssumeRolePolicyStd = Column('assume_role_policy_std', JSON, nullable=True)
