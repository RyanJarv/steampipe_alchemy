...
class AwsLambdaVersion(Base, FormatMixins):
    ...
    dead_letter_config = Column('dead_letter_config', JSON, nullable=True)
    file_system_configs = Column('file_system_configs', JSON, nullable=True)
    image_config_response = Column('image_config_response', JSON, nullable=True)
    layers = Column('layers', JSON, nullable=True)
    logging_config = Column('logging_config', JSON, nullable=True)
    runtime_version_config = Column('runtime_version_config', JSON, nullable=True)
    ...
    ephemeral_storage_size = Column('ephemeral_storage_size', BigInteger, nullable=True)
    ...
    signing_job_arn = Column('signing_job_arn', Text, nullable=True)
    signing_profile_version_arn = Column('signing_profile_version_arn', Text, nullable=True)
