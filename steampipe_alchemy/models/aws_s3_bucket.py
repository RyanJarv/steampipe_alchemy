...
class AwsS3Bucket(Base, FormatMixins):
    ...
    website_configuration = Column('website_configuration', JSON, nullable=True)
    ...
    event_notification_configuration = Column('event_notification_configuration', JSON, nullable=True)
    ...
    object_lock_configuration = Column('object_lock_configuration', JSON, nullable=True)
    object_ownership_controls = Column('object_ownership_controls', JSON, nullable=True)
