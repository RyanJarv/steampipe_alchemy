...
class AwsRdsDbInstance(Base, FormatMixins):
...
class AwsRdsDbInstanceLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_rds_db_instance_local'
    db_instance_identifier = Column('db_instance_identifier', Text, nullable=True)
    arn = Column('arn', Text, primary_key=True, nullable=True)
    db_cluster_identifier = Column('db_cluster_identifier', Text, nullable=True)
    status = Column('status', Text, nullable=True)
...
cache = select(AwsRdsDbInstance).select_from(AwsRdsDbInstance)
create_materialized_view('aws_rds_db_instance_local', cache, db.metadata_materialized)
