...
class AwsDirectoryServiceDirectory(Base, FormatMixins):
    ...
    event_topics = Column('event_topics', JSON, nullable=True)
    snapshot_limit = Column('snapshot_limit', JSON, nullable=True)
    ...
    shared_directories = Column('shared_directories', JSON, nullable=True)
