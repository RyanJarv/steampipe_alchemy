...
class AwsElasticacheCluster(Base, FormatMixins):
...
class AwsElasticacheClusterLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_elasticache_cluster_local'
    cache_cluster_id = Column('cache_cluster_id', Text, nullable=True)
    arn = Column('arn', Text, primary_key=True, nullable=True)
    cache_node_type = Column('cache_node_type', Text, nullable=True)
    cache_cluster_status = Column('cache_cluster_status', Text, nullable=True)
...
cache = select(AwsElasticacheCluster).select_from(AwsElasticacheCluster)
create_materialized_view('aws_elasticache_cluster_local', cache, db.metadata_materialized)
