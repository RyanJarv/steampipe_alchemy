...
class AwsElasticacheCluster(Base, FormatMixins):
    ...
    log_delivery_configurations = Column('log_delivery_configurations', JSON, nullable=True)
    ...
    replication_group_log_delivery_enabled = Column('replication_group_log_delivery_enabled', Boolean, nullable=True)
    ...
    cache_nodes = Column('cache_nodes', JSON, nullable=True)
    cache_security_groups = Column('cache_security_groups', JSON, nullable=True)
    ...
    preferred_outpost_arn = Column('preferred_outpost_arn', Text, nullable=True)
    sp_connection_name = Column('sp_connection_name', Text, nullable=True)
    transit_encryption_mode = Column('transit_encryption_mode', Text, nullable=True)
    ...
    ip_discovery = Column('ip_discovery', Text, nullable=True)
    network_type = Column('network_type', Text, nullable=True)