...
class AwsAcmCertificateLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_acm_certificate_local'
    certificate_arn = Column('certificate_arn', Text, nullable=True)
    certificate = Column('certificate', Text, nullable=True)
    certificate_chain = Column('certificate_chain', Text, nullable=True)
    domain_name = Column('domain_name', Text, nullable=True)
...
cache = select(AwsAcmCertificate).select_from(AwsAcmCertificate)
create_materialized_view('aws_acm_certificate_local', cache, db.metadata_materialized)
