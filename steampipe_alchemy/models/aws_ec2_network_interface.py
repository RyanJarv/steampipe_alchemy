...
class AwsEc2NetworkInterfaceLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_ec2_network_interface_local'
    network_interface_id = Column('network_interface_id', Text, nullable=True)
    status = Column('status', Text, nullable=True)
    interface_type = Column('interface_type', Text, nullable=True)
    description = Column('description', Text, nullable=True)
...
cache = select(AwsEc2NetworkInterface).select_from(AwsEc2NetworkInterface)
create_materialized_view('aws_ec2_network_interface_local', cache, db.metadata_materialized)
