...
class AwsVpcEndpoint(Base, FormatMixins):
...
class AwsVpcEndpointLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_vpc_endpoint_local'
    vpc_endpoint_id = Column('vpc_endpoint_id', Text, nullable=True)
    service_name = Column('service_name', Text, nullable=True)
    owner_id = Column('owner_id', Text, nullable=True)
    vpc_id = Column('vpc_id', Text, nullable=True)
...
cache = select(AwsVpcEndpoint).select_from(AwsVpcEndpoint)
create_materialized_view('aws_vpc_endpoint_local', cache, db.metadata_materialized)
