...
class AwsKinesisFirehoseDeliveryStreamLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_kinesis_firehose_delivery_stream_local'
    delivery_stream_name = Column('delivery_stream_name', Text, nullable=True)
    arn = Column('arn', Text, primary_key=True, nullable=True)
    delivery_stream_status = Column('delivery_stream_status', Text, nullable=True)
    delivery_stream_type = Column('delivery_stream_type', Text, nullable=True)
...
cache = select(AwsKinesisFirehoseDeliveryStream).select_from(AwsKinesisFirehoseDeliveryStream)
create_materialized_view('aws_kinesis_firehose_delivery_stream_local', cache, db.metadata_materialized)
