...
class AwsNeptuneDbClusterSnapshot(Base, FormatMixins):
    __tablename__ = 'aws_neptune_db_cluster_snapshot'
    ...
    db_cluster_snapshot_arn = Column('db_cluster_snapshot_arn', Text, nullable=True)
