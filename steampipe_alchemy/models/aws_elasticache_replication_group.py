...
class AwsElasticacheReplicationGroup(Base, FormatMixins):
...
class AwsElasticacheReplicationGroupLocal(db.BaseEphemeralModels, FormatMixins):
    __tablename__ = 'aws_elasticache_replication_group_local'
    replication_group_id = Column('replication_group_id', Text, nullable=True)
    arn = Column('arn', Text, primary_key=True, nullable=True)
    description = Column('description', Text, nullable=True)
    at_rest_encryption_enabled = Column('at_rest_encryption_enabled', Boolean, nullable=True)
...
cache = select(AwsElasticacheReplicationGroup).select_from(AwsElasticacheReplicationGroup)
create_materialized_view('aws_elasticache_replication_group_local', cache, db.metadata_materialized)
